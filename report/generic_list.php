...
<div id="_load_report"></div>
  ...
  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
    ...
    <ul>
 	...
 	<li><a data-position="left" data-delay="50" data-tooltip="Setup Report" class="tooltipped btn-floating purple">
      <i class="large material-icons" id="reportSetup">donut_small</i>
    </a></li>
    </ul>
  </div>
</div></div>
