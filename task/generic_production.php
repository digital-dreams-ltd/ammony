...
<div style="height:2rem;display:block"><div class="progress hide">
  ...
  <div class="house" id="_<?php echo str_replace(' ','_',$page_title); ?>"><div class="row" id="new_form" style="display:none"> <div class="" >
		<form id="formData">
		...
		<div class="col s12 options_div" >
          ...
          <label for="<?php echo $v1 ?>" class="active"><?php echo $coldesc[$k][$k1] ?></label><?php } ?></div><?php } ?></div></div></div></div>
			...
			<div><input type="text" id="_count" name='count' class='count' value="2" style="display:none" /><input type="text" id="_invoice_count" name='invoice_count' class='invoice_count' value="0" style="display:none" /><input type="text" id="_amount" name='amount' value="" style="display:none" /><input type="hidden" id="_trans_type" name='trans_type' value="<?php echo $_type ?>" /><input type="text" id="_tid" name='tid'  value="" style="display:none" /><input type="text" id="_trans_no" name='trans_no' value="" class="uniqueId" style="display:none" /><input name="_pageType" type="hidden" id="page_type" value="<?php echo $pageType ?>" /><?php if(!empty($client)) { ?><input name="_client" type="hidden" id="_client" value="<?php echo $client ?>" /> <?php } ?>
		...
		<?php  if(!empty($c_type) && !empty($client)) { ?>  
